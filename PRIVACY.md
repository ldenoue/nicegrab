# NiceGrab Privacy Policy

**Effective date: August 6, 2026**

NiceGrab is developed by AppBlit LLC. Your privacy is simple: NiceGrab does not collect, transmit, sell, share, or track personal data.
...
NiceGrab contains no advertising, analytics SDKs, tracking technology, user accounts, or third-party data services.

## Data retention and deletion

Because NiceGrab does not collect data, AppBlit LLC has no personal data to retain or delete. You can remove locally stored preferences and bookmarks by deleting the app and its container from your Mac.

## Changes to this policy

If NiceGrab's privacy practices change, this policy will be updated before the related app version is released.

## Contact

For privacy questions, contact AppBlit LLC through the [NiceGrab support page](https://github.com/ldenoue/nicegrab/issues).
